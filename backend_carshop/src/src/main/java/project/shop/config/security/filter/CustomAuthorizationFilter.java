package project.shop.config.security.filter;
...
import project.shop.config.security.JWTManager;
...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
  ...
  public CustomAuthorizationFilter(JWTManager jwtManager, CustomerService customerService) {
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
    ...
    if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
      try {
        ...
        Customer customer = customerService.findById(decodedJWT.getSubject());
